...
export default function LocationsPage() {
  ...
  const limit = profile ? PLAN_LOCATION_LIMITS[profile.plan] : 1;
      ...
      <div className="space-y-3">
        {locations.length === 0 ? (
          ...
          locations.map((loc) => (
            <div
              key={loc.id}
              className="flex items-center justify-between rounded-xl bg-[var(--bg-card)] border border-[var(--border-color)] p-5"
            >
              <div>
